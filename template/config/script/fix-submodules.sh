...
elif [[ $ORIGIN_URL == *"sourcecraft.dev"* ]]; then
	git submodule set-url template/report https://git@git.sourcecraft.dev/yamadharma/academic-laboratory-report-template.git
	git submodule set-url template/presentation https://git@git.sourcecraft.dev/yamadharma/academic-presentation-markdown-template.git
fi
